pipeline {
    ...
    environment {
        ...
        AWSECR = '178020491921.dkr.ecr.ap-northeast-2.amazonaws.com/mypage'
        REGION = 'ap-northeast-2'
    }
    stages {
        stage('Checkout Github') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/mypage']], extensions: [],
        ...
        stage('EKS manifest file update') {
            steps {
                ...
                sh "sed -i 's@${AWSECR}:.*@${AWSECR}:${currentBuild.number}@g' mypage/mypage.yaml"
